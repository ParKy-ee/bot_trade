...
async function run() {
  ...
  // 1. Overall Today Summary (since 2026-09-15 00:01:00 Bangkok Time)
  const [overall] = await conn.query(`
    ...
    FROM trade_results
    WHERE CONVERT_TZ(created_at, '+00:00', '+07:00') >= '2026-09-15 00:01:00'
  `);
  console.log("=== 1. TODAY (SINCE 00:01) OVERALL SUMMARY ===");
  console.table(overall);

  // 2. Breakdown by Model & Mode
  ...
  `);
  console.log("\n=== 2. TODAY BREAKDOWN BY MODEL & MODE ===");
